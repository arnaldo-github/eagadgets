    ...
    <div class="row card main-card">
        ...
        <div class="  col s12 m12 l4 xl5">
          ...
          @if(isset($product->sale) && $product->sale > 0)      <h5 class="center red-text" style=" font-size: 20px;font-weight: 700;">
                ...
                href="https://wa.me/{{$product->whatsapp_number}}?text={{$message . ' '. url()->full()}}"
                ...
                <p id="callButton" style="margin-top: 10px;" class="center"><a  href="tel:{{$product->phone_number}}" style="background-color:  rgb(83, 200, 243) ;width: 80%; height: 100%; padding-top: 10px; padding-bottom: 10px;" class="btn black">Ligar <span class="flaticon-phone-call"></span>
</a> <br>
                </p>
            </div>
        </div>
     ...
     <script>
         $( document ).ready(function() {
            ...
            $( "#callButton" ).click(function() {
                ...
                fbq('track', 'Purchase', {value: {{$product->price}}, currency: 'MZN'});
            });
        });
